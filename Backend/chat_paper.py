...
class Reader:
    ...
    def __init__(self, key_word, query, filter_keys,
        ...
        OPENAI_KEY = self.config["OpenAI"].get("OPENAI_API_KEYS")[1:-1].split(",")[0]
        print (OPENAI_KEY)

        # OPENAI_KEY = 'sk-4k6c3t1Tf4Dk50hy24CbF3Ae946f4e4f8109878d5621Ef87'
        # 获取某个键对应的值
        ...
        print(self.chat_api_list, self.chatgpt_model)
    ...
    def summary_with_chat(self, paper_list):
        ...
        return chat_summary_text, '\n'.join(paper_list[0].section_text_dict.values()), result
